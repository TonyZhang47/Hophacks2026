...
export const STOP_WORDS = new Set(
  `a an and are as at be but by for from had has have he her his i if in is it its me my not of on or our she so that the their them they this to was we were what when which with you your im ive dont didnt cant just really very also been being than then there these those into about after before while more most some such only other one two day days now out first few bit lot little much too even off up down way well much thing things something anything went going goes made make makes said say says know knew think thought around away couple less better lot bit week weeks month months take taking took get got like feel felt still every each also`.split(
    /\s+/,
  ),
);
