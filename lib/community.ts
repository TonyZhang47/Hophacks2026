...
Write 2 to 4 short sentences, with one main idea per sentence. Keep each sentence to at most 25 words and list no more than 4 effects in a sentence. Prioritize the most common and serious effects identified in the label. Keep the entire summary within 2 to 4 sentences; do not add filler or repeat information.
